        ...
        <div className='px-[24px] md:px-[64px] lg:px-[96px] min-h-screen w-full mt-[60px]'>
            ...
            <div className='w-full h-fit flex lg:flex-row flex-col-reverse items-start justify-between min-h-screen lg:pb-20 pb-10 '>
                ...
                >
                    <div className='w-full h-fit mt-3'>
                        ...
                        <input
                            ...
                            className='text-black h-[50px] w-full outline-0 px-5 text-secondary border-[1px] rounded-special border-secondary'
                        />
                    </div>
                    <div className='w-full h-fit mt-3'>
                        <label
                        ...
                        <input
                            ...
                            value={formData.mail}
                            onChange={(e) => handleInputChange(e)}
                            className='text-black h-[50px] w-full rounded-special outline-0 px-5 text-secondary border-[1px] border-secondary'
                        />
                    </div>
                    <div className='w-full h-fit mt-3'>
                        <label
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange(e)}
                            className='text-blacks h-[50px] w-full rounded-special outline-0 px-5 text-secondary border-[1px] border-secondary'
                        />
                    </div>
                    ...
                    <div className='w-full h-fit mt-3'>
                        ...
                        <textarea
                            ...
                            className='text-black resize-y max-h-[350px] min-h-[40px] h-[150px] w-full p-5 outline-0 rounded-special border-[1px] border-secondary'>
                        </textarea>
                    </div>
                    ...
                    <div className='w-full h-fit mt-3'>
                        ...
                        <div className='w-full lg:h-[50px] h-fit border-[1px] border-secondary  flex lg:flex-row flex-col items-center justify-between lg:pr-4 pr-0 lg:gap-5 gap-0 rounded-special'>
                            <input
                                type='file'
                                name='file'
                                id='file'
                            ...
                            />
                            <label htmlFor='file' className="cursor-pointer shrink-0 bg-secondary text-secondary lg:h-full h-[50px] lg:w-1/2 w-full grid place-items-center">
                            ...
                            <p className='text-xs w-full flex items-center justify-center h-[50px] px-3 lg:px-0'>
                                ...
                                {formData.file !== null && <span className='text-xl border-[1px] border-secondary rounded-full ml-auto' onClick={handleFileRemove}><IoIosClose /></span>}
                            </p>
                        </div>
                    </div>
                    ...
                    <button
                        type='submit'
                        className='bg-secondary text-secondary w-fit flex lg:px-[100px] px-[50px] lg:py-[20px] py-[10px]  items-center mx-auto lg:mx-0 justify-center gap-5 lg:text-2xl text-xl font-semibold mt-10'>
                ...
                <div className='lg:w-1/3  w-full h-fit '>
                    <div className='border-[1px] border-secondary rounded-special capitalize lg:mt-5 mt-2 lg:px-5 px-2 lg:py-10 py-5 text-center lg:text-start'>
