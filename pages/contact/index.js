...
const Contact = () => {
    ...
    return (
        <div className='px-[24px] md:px-[64px] lg:px-[96px] min-h-screen w-full mt-[60px]'>
            <Navbar />
            <ContactHero />
            <div className='w-full h-fit flex lg:flex-row flex-col-reverse items-start justify-between min-h-screen pb-10 '>
                <form
                ...
                <div className='lg:w-1/4 w-full h-fit capitalize lg:mt-5 mt-2 border-[1px] lg:px-5 px-2 lg:py-20 py-5 text-center lg:text-start'>
