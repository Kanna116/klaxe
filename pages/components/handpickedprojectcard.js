    ...
    return (
        <Link href={`/projects/${url}`}>
            ...
            >
                ...
                />
                <div className='absolute inset-0  lg:group-hover:bg-[#000000aa] bg-gradient-to-t lg:from-transparent from-[#000000aa] to-transparent duration-200 ease-in-out'></div>
