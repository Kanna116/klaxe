    ...
    return (
        <div
            ...
            <div className="w-[75vmin] aspect-square rounded-full border-[1px] relative flex items-center justify-center">
                <div className="absolute top-1/2 left-1/2 w-full aspect-[3/1] origin-center rounded-[50%] duration-700 ease-linear bg-[#ffffff30] border-[1px] md:block lg:block hidden"
                    style={{
                        transform: `translate(-50%,-50%) rotate(${interactiveValues.rotateValue}deg) scaleY(${interactiveValues.scaleYValue})`
                    }}
                ></div>

                <div className="interactive-mover md:hidden lg:hidden block absolute top-1/2 left-1/2 w-full aspect-[3/1] origin-center rounded-[50%] duration-700 ease-linear bg-[#ffffff30] border-[1px] -translate-x-1/2 -translate-y-1/2 rotate-[20deg] "
                ></div>
            </div>
