...
const Footer = () => {
    ...
    return (
        <div className='py-5 gap-4 w-full border-t-[2px] border-white flex flex-col lg:flex-row md:flex-row items-center justify-between z-auto'>
                    ...
                    socialIcons.map((item, index) => {
                        return (
                            <a
                                ...
                                href={item.link}
                                target='_blank'
                                className='hover:scale-[1.5] duration-150'>
