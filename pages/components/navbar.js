...
function Navbar() {
  ...
  return (
    <div className='w-full h-[50px] p-[10px] fixed top-[10px] left-0 lg:px-[96px] md:px-[64px] px-[24px] flex items-center justify-between'>
      ...
      <div className='w-10 aspect-square bg-white rounded-full flex items-center justify-evenly gap-[1px]  flex-col p-[10px]'
      ...
      <ul className="second-menu fixed t-[50vh] bg-red-100 w-[250px] h-[250px]">
        <div className="back">
          <Image
