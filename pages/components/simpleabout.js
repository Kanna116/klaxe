...
function SimpleAbout() {
    return (
        <div className='w-full flex items-center justify-center flex-col gap-5 py-20'>
            ...
            <button className='lg:px-[50px] px-[20px] lg:py-[15px] py-[10px] bg-white text-black text-xs lg:text-xl mt-5 flex gap-2 items-center'>More <span className='text-2xl'><FiArrowUpRight /></span></button>
        </div>
    )
}
